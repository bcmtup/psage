              ...
              return (function (t, e, i, n) {
                  ...
                  function c(t, e) {
                      ...
                      return (
                          v.isString(t)
                              ? b.Easings[t] || (i = !1)
                              : (i = v.isArray(t) && 1 === t.length ? s.apply(null, t) : v.isArray(t) && 2 === t.length ? w.apply(null, t.concat([e])) : !(!v.isArray(t) || 4 !== t.length) && l.apply(null, t)),
                  ...
                  function d(t, e) {
                      ...
                      for (var i = b.State.calls[t][0], o = b.State.calls[t][1], a = b.State.calls[t][2], s = b.State.calls[t][4], l = !1, c = 0, u = i.length; u > c; c++) {
                          var d = i[c].element;
                          if (
                              (e || a.loop || ("none" === a.display && k.setPropertyValue(d, "display", a.display), "hidden" === a.visibility && k.setPropertyValue(d, "visibility", a.visibility)),
                      ...
                      if (!(7 >= h)) {
                          var g = 400,
                              ...
                              b = {
                                  ...
                                  Easings: {},
                                  Promise: e.Promise,
                                  defaults: { queue: "", duration: g, easing: y, begin: n, complete: n, progress: n, display: n, visibility: n, loop: !1, delay: !1, mobileHA: !0, _cacheValues: !0 },
                                  init: function (t) {
                          ...
                          var w = (function () {
                              ...
                              return function t(e, n, o) {
                                  var a,
                                      ...
                                      u = 0;
                                  for (
                                      e = parseFloat(e) || 500, n = parseFloat(n) || 20, o = o || null, l.tension = e, l.friction = n, (a = null !== o) ? ((u = t(e, n)), (r = (u / o) * 0.016)) : (r = 0.016);
                                  ...
                                  function t(t) {
                                      function d(t, e) {
                                          ...
                                          return (
                                              v.isArray(t)
                                                  ? ((i = t[0]),
                                                    (!v.isArray(t[1]) && /^[\d-]/.test(t[1])) || v.isFunction(t[1]) || k.RegEx.isHex.test(t[1])
                                                        ? (r = t[1])
                                                        : ((v.isString(t[1]) && !k.RegEx.isHex.test(t[1])) || v.isArray(t[1])) && ((o = e ? t[1] : c(t[1], s.duration)), t[2] !== n && (r = t[2])))
                                                  : (i = t),
                                              e || (o = o || s.easing),
                                      ...
                                      if ("scroll" === A) {
                                          ...
                                          s.container
                                              ? v.isWrapped(s.container) || v.isNode(s.container)
                                                  ? ((s.container = s.container[0] || s.container), (g = s.container["scroll" + S]), (x = g + p(a).position()[S.toLowerCase()] + O))
                                                  : (s.container = null)
                                              ...
                                              (l = {
                                                  scroll: { rootPropertyValue: !1, startValue: g, currentValue: g, endValue: x, unitType: "", easing: s.easing, scrollData: { container: s.container, direction: S, alternateValue: w } },
                                                  element: a,
                                              }),
                                              ...
                                              if (r(a).isSVG || "tween" === j || !1 !== k.Names.prefixCheck(j)[1] || k.Normalizations.registered[j] !== n) {
                                                  ((s.display !== n && null !== s.display && "none" !== s.display) || (s.visibility !== n && "hidden" !== s.visibility)) && /opacity|filter/.test(q) && !L && 0 !== V && (L = 0),
                                                      s._cacheValues && M && M[q]
                                                          ? (L === n && (L = M[q].endValue + M[q].unitType), ($ = r(a).rootPropertyValueCache[j]))
                                                          : k.Hooks.registered[q]
                                                          ? L === n
                                                              ? (($ = k.getPropertyValue(a, j)), (L = k.getPropertyValue(a, q, $)))
                                                  ...
                                                  if (
                                                      ...
                                                      (V = parseFloat(V) || 0),
                                                      "%" === W &&
                                                          (/^(fontSize|lineHeight)$/.test(q) ? ((V /= 100), (W = "em")) : /^scale/.test(q) ? ((V /= 100), (W = "")) : /(Red|Green|Blue)$/i.test(q) && ((V = (V / 100) * 255), (W = ""))),
                                                      /[\/*]/.test(Q))
                                                  )
                                                      W = F;
                                                  else if (F !== W && 0 !== L)
                                                      if (0 === V) W = F;
                                                          ...
                                                          o =
                                                              ...
                                                              (function () {
                                                                  ...
                                                                  return (
                                                                      null === I.remToPx && (I.remToPx = parseFloat(k.getPropertyValue(i.body, "fontSize")) || 16),
                                      ...
                                      l.element &&
                                          ...
                                          (r(a).isAnimating = !0),
                                          T === C - 1 ? (b.State.calls.push([D, f, s, null, P.resolver]), !1 === b.State.isTicking && ((b.State.isTicking = !0), u())) : T++);
                                  }
                                  var o,
                                      a = this,
                              ...
                              if ((v.isWrapped(this) ? ((s = !1), (h = 0), (f = this), (l = this)) : ((s = !0), (h = 1), (f = w ? arguments[0].elements || arguments[0].e : arguments[0])), (f = a(f)))) {
                                  ...
                                  if (!/^(stop|finish)$/i.test(m) && !p.isPlainObject(y)) {
                                      ...
                                      for (var S = h + 1; S < arguments.length; S++)
                                          v.isArray(arguments[S]) || (!/^(fast|normal|slow)$/i.test(arguments[S]) && !/^\d/.test(arguments[S]))
                                                  ...
                                                  return (
                                                      ...
                                                      p.each(f, function (t, e) {
                                                          parseFloat(z.stagger) ? (z.delay = _ + parseFloat(z.stagger) * t) : v.isFunction(z.stagger) && (z.delay = _ + z.stagger.call(e, t, C)),
                                                              z.drag &&
                                                                  ((z.duration = parseFloat(E) || (/^(callout|transition)/.test(m) ? 1e3 : g)),
                                                                  (z.duration = Math.max(z.duration * (z.backwards ? 1 - t / C : (t + 1) / C), 0.75 * z.duration, 200))),
        ...
        c(L, T, {
            handler: function (t) {
                ...
                e & xt && 0 === t.button && (this.pressed = !0),
                    e & Ct && 1 !== t.which && (e = Tt),
                    this.pressed && this.allow && (e & Tt && (this.pressed = !1), this.callback(this.manager, e, { pointers: [t], changedPointers: [t], pointerType: wt, srcEvent: t }));
            },
        });
            ...
            c(j, T, {
                handler: function (t) {
                    ...
                    o & xt && (0 === t.button || r) ? 0 > s && (e.push(t), (s = e.length - 1)) : o & (Tt | St) && (i = !0),
                        0 > s || ((e[s] = t), this.callback(this.manager, o, { pointers: e, changedPointers: [t], pointerType: a, srcEvent: t }), i && e.splice(s, 1));
                },
            });
        ...
        (Y.prototype = {
            ...
            recognize: function (t) {
                ...
                return d(this.options.enable, [this, e])
                    ? (this.state & (re | se | 32) && (this.state = ie), (this.state = this.process(e)), void (this.state & (ne | oe | ae | se) && this.tryEmit(e)))
            ...
            c(J, Z, {
                ...
                directionTest: function (t) {
                    var e = this.options,
                        ...
                        r = t.deltaY;
                    return (
                        o & e.direction || (e.direction & Mt ? ((o = 0 === a ? Pt : 0 > a ? At : Ot), (i = a != this.pX), (n = Math.abs(t.deltaX))) : ((o = 0 === r ? Pt : 0 > r ? Et : _t), (i = r != this.pY), (n = Math.abs(t.deltaY)))),
                        (t.direction = o),
            ...
            c(it, Z, {
                defaults: { event: "swipe", threshold: 10, velocity: 0.65, direction: Mt | It, pointers: 1 },
                getTouchAction: function () {
                ...
                attrTest: function (t) {
                    ...
                    return (
                        i & (Mt | It) ? (e = t.velocity) : i & Mt ? (e = t.velocityX) : i & It && (e = t.velocityY),
...
(Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity),
                    ...
                    : void this.each(function () {
                          ...
                          function o(e) {
                              ...
                              var g = 0,
                                  ...
                                  b = r.parent();
                              if (
                                  (b.is("body") || (b[0].scrollHeight > b[0].clientHeight && (g = b[0].scrollTop), b[0].scrollWidth > b[0].clientWidth && (y = b[0].scrollLeft)),
                              ...
                              "left" === h ? ((f = s.gutter), (v = r.position().left + f)) : "right" === h && (c.stop(!0, !0).css({ opacity: 0, left: 0 }), (v = r.position().left + i - c.width() + (f = -s.gutter))),
                                  ...
                                  r.on("click." + r.attr("id"), function (e) {
                                      l ||
                                          (r[0] != e.currentTarget || r.hasClass("active") || 0 !== t(e.target).closest(".dropdown-content").length
                                              ...
                                              : (e.preventDefault(), s.stopPropagation && e.stopPropagation(), o("click")));
                                  });
    ...
    (function (t, e) {
        "use strict";
        var i = { opacity: 0.5, inDuration: 250, outDuration: 250, ready: void 0, complete: void 0, dismissible: !0, startingTop: "4%", endingTop: "10%" },
            n = (function () {
                function n(e, i) {
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    t.extend(this.$el[0].style, { display: "block", opacity: 0 }),
                                        ...
                                        e(this.$overlay[0], { opacity: this.options.opacity }, { duration: this.options.inDuration, queue: !1, ease: "easeOutCubic" });
                                    var n = {
                                    ...
                                    this.$el[0].classList.contains("bottom-sheet")
                                        ...
                                        : (e.hook(this.$el[0], "scaleX", 0.7), (this.$el[0].style.top = this.options.startingTop), e(this.$el[0], { top: this.options.endingTop, opacity: 1, scaleX: 1 }, n));
                                },
                            },
                            {
                                key: "animateOut",
            ...
            init: function (e) {
                ...
                return this.each(function (i) {
                    var o,
                        ...
                        k = function (t) {
                            m - t >= 0
                                ? (s.velocity({ right: b(o) }, { duration: 300, queue: !1, easing: "easeOutQuad" }), s.velocity({ left: w(o) }, { duration: 300, queue: !1, easing: "easeOutQuad", delay: 90 }))
                                : (s.velocity({ left: w(o) }, { duration: 300, queue: !1, easing: "easeOutQuad" }), s.velocity({ right: b(o) }, { duration: 300, queue: !1, easing: "easeOutQuad", delay: 90 }));
                        };
                              ...
                              p = setTimeout(function () {
                                  ...
                                  "top" === s
                                      ? ((t = o.offset().top - l - 5),
                                        ...
                                        (n = e(i, t, p, l)),
                                        (f = "-10px"),
                                        u.css({ bottom: 0, left: 0, borderRadius: "14px 14px 0 0", transformOrigin: "50% 100%", marginTop: l, marginLeft: p / 2 - m / 2 }))
                                      : "left" === s
                                      ? ((t = o.offset().top + r / 2 - l / 2),
                                        (i = o.offset().left - p - 5),
                                        (n = e(i, t, p, l)),
                                        (v = "-10px"),
                                        u.css({ top: "-7px", right: 0, width: "14px", height: "14px", borderRadius: "14px 0 0 14px", transformOrigin: "95% 50%", marginTop: l / 2, marginLeft: p }))
                                      : "right" === s
                                      ? ((t = o.offset().top + r / 2 - l / 2),
                                        (i = o.offset().left + a + 5),
                                        (n = e(i, t, p, l)),
                                      ...
                                      : ((t = o.offset().top + o.outerHeight() + 5), (i = o.offset().left + a / 2 - p / 2), (n = e(i, t, p, l)), (f = "+10px"), u.css({ top: 0, left: 0, marginLeft: p / 2 - m / 2 })),
                                      c.css({ top: n.y, left: n.x }),
                                      (y = (Math.SQRT2 * p) / parseInt(m)),
                                      (b = (Math.SQRT2 * l) / parseInt(g)),
                                      (w = Math.max(y, b)),
                                      c.velocity({ translateY: f, translateX: v }, { duration: 350, queue: !1 }).velocity({ opacity: 1 }, { duration: 300, delay: 50, queue: !1 }),
                                      u.css({ visibility: "visible" }).velocity({ opacity: 1 }, { duration: 55, delay: 0, queue: !1 }).velocity({ scaleX: w, scaleY: w }, { duration: 300, delay: 0, queue: !1, easing: "easeInOutQuad" });
                              }, r);
                          },
    ...
    (function (t, e) {
        "use strict";
        var i = { displayLength: 1 / 0, inDuration: 300, outDuration: 375, className: void 0, completeCallback: void 0, activationPercent: 0.8 },
            n = (function () {
                function n(e, i, o, a) {
                ...
                (e = t.extend(i, e)),
                    t(this).each(function () {
                        ...
                        e.draggable ? (a.length && a.remove(), (a = t('<div class="drag-target"></div>').attr("data-sidenav", n)), t("body").append(a)) : (a = t()),
                            "left" == e.edge ? (o.css("transform", "translateX(-100%)"), a.css({ left: 0 })) : (o.addClass("right-aligned").css("transform", "translateX(100%)"), a.css({ right: 0 })),
                            ...
                            a
                                ...
                                .on("pan", function (i) {
                                    if ("touch" == i.gesture.pointerType) {
                                        ...
                                        var p;
                                        "left" === e.edge
                                            ? ((p = n / e.menuWidth), c.velocity({ opacity: p }, { duration: 10, queue: !1, easing: "easeOutQuad" }))
                                            : ((p = Math.abs((n - window.innerWidth) / e.menuWidth)), c.velocity({ opacity: p }, { duration: 10, queue: !1, easing: "easeOutQuad" }));
                                    }
                                })
                            ...
                            i.off("click.sidenav").on("click.sidenav", function () {
                                if (!0 === l) (l = !1), (s = !1), r();
                                    ...
                                    i.css("overflow", "hidden"),
                                        ...
                                        t("body").append(a),
                                        "left" === e.edge
                                            ? (a.css({ width: "50%", right: 0, left: "" }), o.velocity({ translateX: [0, -1 * e.menuWidth] }, { duration: 300, queue: !1, easing: "easeOutQuad" }))
                                            : (a.css({ width: "50%", right: "", left: 0 }), o.velocity({ translateX: [0, e.menuWidth] }, { duration: 300, queue: !1, easing: "easeOutQuad" })),
                                    ...
                                    if (!t(this).hasClass("disabled") && !t(this).hasClass("optgroup")) {
                                        ...
                                        o
                                            ? (t('input[type="checkbox"]', this).prop("checked", function (t, e) {
                                              ...
                                              (s = i(u, a, n)),
                                              m.trigger("focus"))
                                            : (l.find("li").removeClass("active"), t(this).toggleClass("active"), m.val(t(this).text())),
                                            g(l, t(this)),
                ...
                return (
                    ...
                    this.each(function () {
                        ...
                        -1 != u && (o = c.eq(u)),
                            ...
                            o ? o.show() : (c.first().addClass("active").velocity({ opacity: 1 }, { duration: e.transition, queue: !1, easing: "easeOutQuad" }), (u = 0), (o = c.eq(u)), e.indicators && a.eq(u).addClass("active")),
                        ...
                        s
                            ...
                            .on("pan", function (t) {
                                if ("touch" === t.gesture.pointerType) {
                                    ...
                                    var a;
                                    p && (0 === (a = $curr_slide.next()).length && (a = c.first()), a.velocity({ opacity: 1 }, { duration: 300, queue: !1, easing: "easeOutQuad" })),
                                        h && (0 === (a = $curr_slide.prev()).length && (a = c.last()), a.velocity({ opacity: 1 }, { duration: 300, queue: !1, easing: "easeOutQuad" }));
                                }
                            })
                            ...
                            e.css({ transform: "", transition: "transform .2s cubic-bezier(0.550, 0.085, 0.680, 0.530), background-color 0s linear .2s" }),
                                ...
                                setTimeout(function () {
                                    e.css({ overflow: "hidden", "background-color": p }),
                                        d.css({ transform: "scale(" + a + ")", transition: "transform .2s cubic-bezier(0.550, 0.055, 0.675, 0.190)" }),
    ...
    (function (t) {
        ...
        function e(a, s, u, d) {
            ...
            function v() {
                var e;
                !0 === w.hiddenName ? ((e = a.name), (a.name = "")) : (e = (e = ["string" == typeof w.hiddenPrefix ? w.hiddenPrefix : "", "string" == typeof w.hiddenSuffix ? w.hiddenSuffix : "_submit"])[0] + a.name + e[1]),
                    ...
                    start: function () {
                        return b && b.start
                            ...
                            : ((b.methods = {}),
                              ...
                              T.on({ start: T.component.onStart, render: T.component.onRender, stop: T.component.onStop, open: T.component.onOpen, close: T.component.onClose, set: T.component.onSet }).on({
                                  start: w.onStart,
                                  render: w.onRender,
                                  stop: w.onStop,
                                  open: w.onOpen,
        ...
        (i.prototype.set = function (t, e, i) {
            ...
            (i.prototype.create = function (t, i, o) {
                ...
                return (
                    ...
                    i == -1 / 0 || i == 1 / 0
                        ...
                        : (i = n.isInteger(i) || n.isDate(i) ? r.normalize(new Date(i), o) : r.now(t, i, o)),
            ...
            (i.prototype.validate = function (t, i, o) {
                ...
                if ((!o || !o.nav) && ((!p && c.disabled(i)) || (p && c.disabled(i) && (v || a || r)) || (!p && (i.pick <= h.pick || i.pick >= f.pick))))
                    for (
                        ...
                        i.pick <= h.pick
                            ? ((s = !0), (d = 1), (i = c.create([h.year, h.month, h.date + (i.pick === h.pick ? 0 : -1)])))
            ...
            (i.prototype.isDateExact = function (t, i) {
                ...
                return (n.isInteger(t) && n.isInteger(i)) || ("boolean" == typeof t && "boolean" == typeof i)
                    ...
                    : !(!e.isPlainObject(t) || !e.isPlainObject(i)) && o.isDateExact(t.from, i.from) && o.isDateExact(t.to, i.to);
            }),
                    ...
                    n.node(
                        ...
                        n.node(
                            ...
                            n.node(
                                                                    ...
                                                                    return [
                                                                        n.node(
                                                                            ...
                                                                            "data-pick=" +
                                                                                t.pick +
                                                                                " " +
                                                                                n.ariaAttr({ role: "gridcell", label: f, selected: !(!o || e.$node.val() !== f) || null, activedescendant: !!p || null, disabled: !!h || null }) +
                                                                                " " +
                                                                                (h ? "" : 'tabindex="0"')
                                                                        ),
                                                                        "",
                                ...
                                n.node(
                                    "div",
                                    n.node("button", i.today, "btn-flat picker__today waves-effect", "type=button data-pick=" + a.pick + (t && !e.disabled(a) ? "" : " disabled") + " " + n.ariaAttr({ controls: e.$node[0].id })) +
                                        n.node("button", i.clear, "btn-flat picker__clear waves-effect", "type=button data-clear=1" + (t ? "" : " disabled") + " " + n.ariaAttr({ controls: e.$node[0].id })) +
                                        n.node("button", i.close, "btn-flat picker__close waves-effect", "type=button data-close=true " + (t ? "" : " disabled") + " " + n.ariaAttr({ controls: e.$node[0].id })),
                                    i.klass.footer
                                ),
    ...
    (function (t) {
                    ...
                    (r.ampmclickable
                        ? (this.spanAmPm.empty(),
                          ...
                          t('<div id="click-pm">PM</div>')
                              ...
                              .appendTo(this.spanAmPm))
                        : (this.spanAmPm.empty(), t('<div id="click-am">AM</div>').appendTo(this.spanAmPm), t('<div id="click-pm">PM</div>').appendTo(this.spanAmPm))),
                t('<button type="button" class="btn-flat picker__clear" tabindex="' + (r.twelvehour ? "3" : "1") + '">' + r.cleartext + "</button>")
                    .click(t.proxy(this.clear, this))
                    .appendTo(this.footer),
                t('<button type="button" class="btn-flat picker__close" tabindex="' + (r.twelvehour ? "3" : "1") + '">' + r.canceltext + "</button>")
                    .click(t.proxy(this.hide, this))
                    .appendTo(this.footer),
                t('<button type="button" class="btn-flat picker__close" tabindex="' + (r.twelvehour ? "3" : "1") + '">' + r.donetext + "</button>")
        ...
        (o.DEFAULTS = { default: "", fromnow: 0, donetext: "Ok", cleartext: "Clear", canceltext: "Cancel", autoclose: !1, ampmclickable: !0, darktheme: !1, twelvehour: !0, vibrate: !0 }),
            ...
            (o.prototype.setHand = function (e, n, o, a) {
                ...
                if (
                    ...
                    (r = Math.round(s / u)),
                    (s = r * u),
                    p.twelvehour ? (l ? 0 === r && (r = 12) : (o && (r *= 5), 60 === r && (r = 0))) : l ? (12 === r && (r = 0), (r = h ? (0 === r ? 12 : r) : 0 === r ? 0 : r + 12)) : (o && (r *= 5), 60 === r && (r = 0)),
                ...
                return this.each(function (i) {
                    ...
                    function s(i) {
                        ...
                        if (
                            ...
                            (l = (-s * a * 2) / x),
                            (o = C >> 1),
                            e.fullWidth ? (u = "translateX(0)") : ((u = "translateX(" + (j[0].clientWidth - m) / 2 + "px) "), (u += "translateY(" + (j[0].clientHeight - g) / 2 + "px)")),
                            N)
                        ) {
                            var p = w % C,
                        ...
                        for (
                            (!W || (w >= 0 && w < C)) &&
                                ((c = v[r(w)]),
                                t(c).hasClass("active") || (j.find(".carousel-item").removeClass("active"), t(c).addClass("active")),
                            ...
                            e.fullWidth ? ((zTranslation = e.dist), (tweenedOpacity = n === o && a < 0 ? 1 - l : 1)) : ((zTranslation = e.dist * (2 * n + l * s)), (tweenedOpacity = 1 - 0.2 * (2 * n + l * s))),
                                (!W || w + n < C) &&
                                    (((c = v[r(w + n)]).style[_] = u + " translateX(" + (e.shift + (x * n - a) / 2) + "px) translateZ(" + zTranslation + "px)"),
                                    (c.style.zIndex = -n),
                                    (c.style.opacity = tweenedOpacity),
                                    (c.style.display = "block")),
                                e.fullWidth ? ((zTranslation = e.dist), (tweenedOpacity = n === o && a > 0 ? 1 - l : 1)) : ((zTranslation = e.dist * (2 * n - l * s)), (tweenedOpacity = 1 - 0.2 * (2 * n - l * s))),
                        ...
                        if (
                            ((!W || (w >= 0 && w < C)) &&
                                (((c = v[r(w)]).style[_] = u + " translateX(" + -a / 2 + "px) translateX(" + s * e.shift * l + "px) translateZ(" + e.dist * l + "px)"),
                                (c.style.zIndex = 0),
                                e.fullWidth ? (tweenedOpacity = 1) : (tweenedOpacity = 1 - 0.2 * l),
                                (c.style.opacity = tweenedOpacity),
                                (c.style.display = "block")),
                    ...
                    function l() {
                        var t, e, i;
                        (e = (t = Date.now()) - I), (I = t), (i = b - M), (M = b), (O = 0.8 * ((1e3 * i) / (1 + e)) + 0.2 * O);
                    }
                    function c() {
                        var t, i;
                    ...
                    var l = function () {
                        ...
                        c = function () {
                            ...
                            (H.top = b ? T : ""),
                                ...
                                (H.position = P),
                                o.css(H),
                                s.css({ width: A, height: O, top: E, right: 0, bottom: 0, left: _, padding: M, verticalAlign: I }),
